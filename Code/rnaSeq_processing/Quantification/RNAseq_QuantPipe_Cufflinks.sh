...
### Static inputs
counts_dirname="cufflinks_v37"
cufflinksscript_fp="/stg2/data2/barton/Code/seq_processing/RNAseq/Quantification/Subscripts/cufflinks_counts.sh"
...
### Run script
sbatch --wait -a $arraycommand $cufflinksscript_fp $input_fp $gtf_fp
wait
